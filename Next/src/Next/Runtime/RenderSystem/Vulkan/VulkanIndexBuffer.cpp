...
namespace Next {
	...
	VulkanIndexBuffer::VulkanIndexBuffer(size_t bufferSize)
		:m_BufferSize(bufferSize)
	{
		...
		vertexBufferCreateInfo.usage = VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_INDEX_BUFFER_BIT;
	...
	void VulkanIndexBuffer::SetData(void* pData, size_t size, uint32_t bufferPosOffset /*= 0*/)
	{
