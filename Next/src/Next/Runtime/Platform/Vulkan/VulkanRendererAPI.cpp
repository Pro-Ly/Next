...
namespace Next {
	...
	void VulkanRendererAPI::Init(GLFWwindow* window)
	{
		this->window = window;
	...
	VulkanRendererAPI::QueueFamilyIndices VulkanRendererAPI::findQueueFamilies(VkPhysicalDevice device) {
	...
	VulkanRendererAPI::SwapChainSupportDetails VulkanRendererAPI::querySwapChainSupport(VkPhysicalDevice device) {
